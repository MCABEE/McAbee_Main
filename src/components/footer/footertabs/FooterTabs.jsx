         ...
         data && (
            <div className='footerTabs pt-3'>
                ...
                <ul className="nav flex-column">
                    ...
                    <li className="nav-item my-1"><a href="#" className="nav-link p-0 text-body-secondary">{data[4]}</a></li>
                    <li className="nav-item my-1"><a href="#" className="nav-link p-0 text-body-secondary">{data[5]}</a></li>
                </ul>
            </div>
        )
    )
